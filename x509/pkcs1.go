...
func ParsePKCS1PrivateKey(der []byte) (key *rsa.PrivateKey, err error) {
	return parsePKCS1PrivateKey(der, true)
}
func FastParsePKCS1PrivateKey(der []byte) (key *rsa.PrivateKey, err error) {
	return parsePKCS1PrivateKey(der, false)
}
func parsePKCS1PrivateKey(der []byte, precompute bool) (key *rsa.PrivateKey, err error) {
